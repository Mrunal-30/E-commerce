    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
            ...
            <div className="flex gap-2">
              {productData.sizes.map((item, index) => (
                <button
                  ...
                  key={index}
                  className={`cursor-pointer border px-4 py-2 rounded hover:bg-gray-200 ${
      ...
      <div className="mt-20">
        <div className="flex ">
          ...
          <p className="border px-6 py-3 text-sm">Reviews (122)</p>
        </div>
